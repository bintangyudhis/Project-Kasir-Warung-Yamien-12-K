...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        if (Auth::id() === $user->id){
            ...
            if($user->role !== 'admin') {
                return redirect()->route('dashboard')->with('success', 'Role anda berhasil diubah');
            }
        ...
        if ($currentUserRole == 'admin') {
            ...
            // LOGIKA BARU: Jika admin mengubah role user tersebut menjadi 'cashier'
            // Maka redirect ke halaman profil user tersebut, bukan ke index list user
            if ($user->role == 'cashier') {
                return redirect()->route('profile.show', $user->id)->with('success', 'Profile pengguna berhasil diperbarui!');
            }

            // Jika role bukan cashier (misal sesama admin), kembalikan ke daftar user
            return redirect()->route('users.index')->with('success', 'Data pengguna berhasil diperbarui!');
            
        } else {
            // Jika bukan admin (user edit profil sendiri)
