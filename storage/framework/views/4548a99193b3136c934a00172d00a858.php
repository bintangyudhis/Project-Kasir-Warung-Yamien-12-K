...
<div class="am-wrap">
    ...
    <div class="am-grid">
        ...
        <aside class="am-sidebar">
            ...
            <div class="am-stats">
                <div class="am-stats-num"><?php echo e($users->total()); ?></div>
            ...
            <div class="am-main-card">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="tc">
                                        <?php if($user->photo): ?>
                                            <img
                                                ...
                                                class="am-avatar"
                                                alt="Foto <?php echo e($user->username); ?>"
                                            >
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <span class="am-uname"><?php echo e($user->username); ?></span>
                                    </td>
                                    <td><?php echo e($user->fullname); ?></td>
                                    <td title="<?php echo e($user->email); ?>"><?php echo e($user->email); ?></td>
                                    <td class="tc">
                                    ...
                                    <td class="tc">
                                        <div class="am-actions">
                                            <a
                                                ...
                                                title="Edit <?php echo e($user->username); ?>"
                                            >
                                            ...
                                            >
                                                ...
                                                <button
                                                    ...
                                                    title="Hapus <?php echo e($user->username); ?>"
                                                >
                ...
                <div class="am-pagination">
                    <div class="am-page-info">
                        Data <?php echo e($users->firstItem() ?? 0); ?> – <?php echo e($users->lastItem() ?? 0); ?>

                        dari <?php echo e($users->total()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\VICTUS\Documents\metimev4\resources\views/users/index.blade.php ENDPATH**/ ?>