...
<head>
    ...
    <?php if(config('services.midtrans.isProduction')): ?>
...
<body>
    <div class="payment-container">
        ...
        <p style="color: #666; margin-bottom: 20px;">Order #<?php echo e($order->id); ?></p>
        ...
        <div class="order-info">
            ...
            <p>
                <span>Tanggal:</span>
                <strong><?php echo e(\Carbon\Carbon::parse($order->order_date)->format('d M Y')); ?></strong>
            </p>
            <?php if($order->booking): ?>
            <p>
                <span>Meja:</span>
                <strong><?php echo e($order->booking->table->table_number); ?></strong>
            </p>
            <?php else: ?>
            <p>
                <span>Tipe:</span>
        ...
        document.getElementById('pay-button').addEventListener('click', function() {
            ...
            snap.pay('<?php echo e($snapToken); ?>', {
                onSuccess: function(result) {
                    ...
                    window.location.href = "<?php echo e(route('orders.show', $order->id)); ?>?payment=success";
                },
                onPending: function(result) {
                    console.log('pending', result);

                    window.location.href = "<?php echo e(route('orders.show', $order->id)); ?>?payment=pending";
                },
...
<?php /**PATH C:\Users\VICTUS\Downloads\metimev2\resources\views/kasir/payment/midtrans.blade.php ENDPATH**/ ?>