...
<head>
    ...
    <title>Struk Pesanan - <?php echo e($order->payment->transaction_id ?? 'N/A'); ?></title>
...
<body>
    ...
    <div class="screen-only" style="background: #f5f5f5; padding: 20px 0;">
        ...
        <?php if(request('payment') == 'success'): ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert" style="max-width: 600px; margin: 0 auto 20px;">
        ...
        <?php if(request('payment') == 'pending'): ?>
    ...
    <div class="receipt-container">
        <div class="thermal-receipt">
            ...
            <div class="info-row">
                ...
                <span><?php echo e($order->payment->transaction_id ?? 'N/A'); ?></span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span><?php echo e($order->booking ? $order->booking->table->table_number : 'Take Away'); ?></span>
            </div>
            ...
            <table>
                ...
                <tbody>
                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td colspan="3"><?php echo e($item->product->name ?? 'Produk Dihapus'); ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td style="text-align: center;"><?php echo e($item->quantity); ?>x</td>
            ...
            <div class="info-row">
                ...
                <span style="text-transform: uppercase;"><?php echo e($order->payment->payment_method); ?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Status</span>
                <span><?php echo e($order->payment->status == 'paid' ? 'LUNAS' : 'PENDING'); ?></span>
            </div>
        ...
        <div class="text-center mt-4 screen-only">
            <a href="<?php echo e(route('orders.index')); ?>" class="btn btn-primary">Buat Pesanan Baru</a>
            <a href="<?php echo e(route('orders.history')); ?>" class="btn btn-secondary">Lihat Riwayat</a>
...
<?php /**PATH D:\kuliah\semester-5\ippl\TUBES\metimev2\resources\views/orders/show.blade.php ENDPATH**/ ?>