...
<?php $__env->startSection('content'); ?>
    <div class="account-edit-wrapper">
        ...
        <div class="account-edit-card">
            ...
            <form class="account-form" action="<?php echo e(route('users.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group profile-section">
                    <div class="avatar-wrapper">
                        <?php if($user->photo): ?>
                            <img src="<?php echo e(asset('storage/' . $user->photo)); ?>" alt="Foto Profil" class="avatar-img">
                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" name="fullname" value="<?php echo e(old('fullname', $user->fullname)); ?>" required class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="username" name="username" value="<?php echo e(old('username', $user->username)); ?>" required class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="role" name="role" required class="form-control">
                            ...
                            <option value="cashier" <?php echo e(old('role', $user->role) == 'cashier' ? 'selected' : ''); ?>>Kasir</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary" href="<?php echo e(route('orders.index')); ?>">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .no-photo-placeholder {
            ...
            font-size: 3.5rem; border: 2px dashed var(--primary);
        }
        ...
        .upload-btn-overlay:hover { transform: scale(1.1); background: var(--primary-dark); }

        .photo-hint { font-size: 0.85rem; color: var(--text-muted); margin: 0; }
        ...
        @media (max-width: 600px) {
            ...
            .account-edit-card { padding: 30px 20px; }
        }

        label {
            font-weight: 600; font-size: 0.95rem; color: var(--text-dark); margin-bottom: 8px;
        }
        .optional-text { font-weight: 400; color: var(--text-muted); font-size: 0.8rem; }

        .form-control {
            padding: 12px 16px; border: 1px solid var(--border-color);
            border-radius: 8px; font-size: 0.95rem; color: var(--text-dark);
            transition: all 0.3s; background-color: #fafafa; width: 100%;
        }
        .form-control:focus {
            border-color: var(--primary); background-color: #fff;
            box-shadow: 0 0 0 4px rgba(255, 102, 51, 0.1); outline: none;
        }
        ...
        .btn {
            ...
            text-decoration: none; gap: 8px; border: none;
        }
        ...
        .btn-secondary {
            background-color: #e2e6ea; color: var(--text-dark);
        }
        .btn-secondary:hover {
            background-color: #dbe1e6; color: #000;
        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\kuliah\semester-5\ippl\metimev4\resources\views/users/edit.blade.php ENDPATH**/ ?>