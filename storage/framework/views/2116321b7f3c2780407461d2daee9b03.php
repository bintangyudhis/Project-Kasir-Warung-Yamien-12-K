...
<?php $__env->startSection('title', 'Edit Produk - MeTime'); ?>
...
<?php $__env->startSection('content'); ?>
            <div class="form-container">
                <h2>Edit Menu</h2>
                <form class="menu-form" action="<?php echo e(route('products.update', $product->id)); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="3" name="description" placeholder="Masukkan deskripsi menu"><?php echo e(old('description', $product->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="price" placeholder="Masukkan harga"
                            value="<?php echo e(old('price', $product->price)); ?>" step="any" required>
                    ...
                    <div class="form-group">
                        ...
                        <?php if(isset($product) && $product->photo): ?>
                            <div style="margin-bottom: 15px;">
                                <img src="<?php echo e(asset('storage/' . $product->photo)); ?>" alt="Foto <?php echo e($product->name); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\VICTUS\Downloads\metimev2\resources\views/products/edit.blade.php ENDPATH**/ ?>