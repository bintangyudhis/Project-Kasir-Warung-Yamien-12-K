...
@section('content')
    <div class="account-edit-wrapper">
        ...
        <div class="account-edit-card">
            ...
            <form class="account-form" action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" name="fullname" value="{{ old('fullname', $user->fullname) }}" required class="form-control">
                        @error('fullname') <small class="error-text">{{ $message }}</small> @enderror
                    </div>

                    <div class="form-group">
                        <label for="username">Username</label>
                        <input type="text" id="username" name="username" value="{{ old('username', $user->username) }}" required class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        @error('role') <small class="error-text">{{ $message }}</small> @enderror
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary" href="{{ route('orders.index') }}">
