...
@push('styles')
    ...
    <style>
        ...
        .profile-role {
            ...
            background-color: #dbeafe; /* Biru muda (sesuai tema) */
...
@section('content')
    <div class="profile-container">
        ...
        <div class="profile-header">
            @if(Auth::user()->photo)
                <img src="{{ asset('storage/' . Auth::user()->photo) }}" alt="Foto Profil" class="profile-photo">
            @else
            ...
            <h1 class="profile-fullname">{{ Auth::user()->fullname }}</h1>
        ...
        <div class="profile-details">
            ...
            <div class="detail-item">
                ...
                <span class="detail-value">{{ Auth::user()->fullname }}</span>
            </div>

            </div>

        <div class="profile-actions">
            <a href="{{ route('cashier.edit', ['user' => Auth::id()]) }}" class="btn btn-save-edit">
