    ...
    <style>
        ...
        * {
        ...
        .about-photo {
            min-height: 420px;
            border-radius: 22px;
            background: url("{{ asset('images/yammien-hero.png') }}") center / cover no-repeat;
    ...
    <header class="site-header">
        <nav class="nav" aria-label="Navigasi utama">
            ...
            <div class="nav-actions">
                ...
                <a href="{{ route('kasir.entry') }}" class="btn btn-primary">Login Kasir</a>
            </div>
        </nav>
    </header>
            ...
            <div class="hero-inner">
                <div class="hero-copy">
                    ...
                    <div class="hero-actions">
                        ...
                        <a href="{{ route('kasir.entry') }}" class="btn">Masuk Sistem Kasir</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="wrap">
                <div class="pos-grid">
                    <div class="pos-copy">
                        ...
                        <a href="{{ route('kasir.entry') }}" class="btn btn-primary">Buka Login Kasir</a>
                    </div>
